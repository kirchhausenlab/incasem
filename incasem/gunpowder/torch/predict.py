...
https://github.com/funkey/gunpowder/blob/master/gunpowder/torch/nodes/predict.py

Changes before porting into this package are recorded at
https://github.com/kirchhausenlab/gunpowder/blob/patch-1.1.4-logging/gunpowder/torch/nodes/predict.py
"""
