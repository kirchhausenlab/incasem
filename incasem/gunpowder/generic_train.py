...
https://github.com/funkey/gunpowder/blob/master/gunpowder/nodes/generic_train.py

Changes before porting into this package are recorded at
https://github.com/kirchhausenlab/gunpowder/blob/patch-1.1.4-logging/gunpowder/nodes/generic_train.py
"""
...
class GenericTrain(BatchFilter):
    ...
    def __init__(
        ...
        self.provided_arrays = list(
            self.outputs.values()) + list(self.gradients.values())
    ...
    def setup(self):
        ...
        if self.spawn_subprocess:
            ...
            # anything goes wrong
            self.worker = ProducerPool(
                [self.__produce_train_batch], queue_size=1)
    ...
    def train_step(self, batch, request):
        ...
        raise NotImplementedError(
            "Class %s does not implement 'train_step'" %
            self.name())
