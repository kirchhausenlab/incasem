...
We will fine-tune the mitochondria model ID `1847`, which was trained on data from cells `46` and `58` (cell*1 and cell_2 from \_Gallusser, 2022*),
with a small amount of additional data from cell `61` (cell*3 from \_Gallusser, 2022*).
